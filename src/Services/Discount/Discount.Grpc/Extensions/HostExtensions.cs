...
namespace Discount.Grpc.Extensions
{
    ...
    {
        public static IHost MigrateDatabase<TContext>(this IHost host)//(this IHost host,int retry?=0)
        {
        ...
        //drop Coupon table if exists then create and insert 2 records
